...
model = SVM(input_dim=X_raw.shape[1], hidden_dim=4, weight_scale=1e-1, reg=0.005)
...
#Iteration 17901 / 18000) loss: 0.318167
#(Epoch 3000 / 3000) train acc: 0.965000; val_acc: 0.925000
#0.935